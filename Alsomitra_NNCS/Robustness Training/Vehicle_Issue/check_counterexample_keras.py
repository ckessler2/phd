...
def verify_properties(counterexample):
    # Load ONNX model
    onnx_model3 = onnx.load('base_model_merged2.onnx')
...
# verify_properties([ 5.0e-4, 0.534515, 0.396457, 0.0, 0.33818, 0.284731, 0.0, 0.0, 0.534515, 0.396457, 0.0, 0.33818, 0.284731, 0.0 ])

verify_properties([5.00e-4, 0.409036, 0.391964, 0.0, 0.388762, 0.0, 0.0, 0.0, 0.409036, 0.391964, 0.0, 0.388762, 0.0, 0.0])