...
speedy              = 5   -- measured in metres/second
error		      = 6   -- measured in meters/second
...
minimumInputValues = [0.0, -pi, -pi, 100.0, 0.0, 0.0, 0.0]

maximumInputValues : UnnormalisedInputVector
maximumInputValues = [60261.0, pi, pi, 1200.0, 1200.0, 1200.0, 1200.0]
...
meanScalingValues = [19791.091, 0.0, 0.0, 650.0, 600.0, 0.0, 0.0]
...
-- (i.e. of type Index 1). The `a ! b` operator lookups index `b` in vector `a`.
minimalScore : Index 1 -> UnnormalisedInputVector -> Bool
...
property3 : Bool
property3 = forall x .
  validInput x and movingTowards x =>
  not (minimalScore e_x x)