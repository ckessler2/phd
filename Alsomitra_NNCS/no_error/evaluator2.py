...
class Evaluator2:
    ...
    def evaluate(history, model, X_test, y_test):
        ...
        # Plot training loss
        Evaluator2.plot_loss(history)
        


        # Make predictions
        predictions = Evaluator2.make_predictions(model, X_test)
        


        # Plot predictions vs true values
        Evaluator2.plot_predictions_vs_true(y_test, predictions)
        
        # Calculate and return metrics
        metrics = Evaluator2.calculate_metrics(y_test, predictions)
