...
import numpy as np
from Train_Classification_NN import load_data
...
acc_test = 100 * round((cm2[0,0]+cm2[1,1]+cm2[2,2])/sum(sum(cm2)),2)

acc_train = 100 * round((cm[0,0]+cm[1,1]+cm[2,2])/sum(sum(cm)),2)
